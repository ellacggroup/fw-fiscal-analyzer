  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-4 text-sm text-gray-700">
          ...
          <p><strong>What gets imported:</strong> The bulk import (Trends → Import) fetches the meeting list for the configured number of years, downloads each agenda PDF and meeting minutes PDF directly from Legistar, and stores them in the application database.</p>
      ...
      content: (
        <div className="space-y-4 text-sm text-gray-700">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><span className="font-semibold text-red-700">NEGATIVE</span> — The proposed use is estimated to cost more to serve than it generates in revenue (R/C ratio below 0.85), or involves foregone revenue (tax abatement, TIRZ).</li>
