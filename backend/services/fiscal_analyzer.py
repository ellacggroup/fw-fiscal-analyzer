...
_CATEGORY_KEYWORDS = {
    ...
    "Right-of-Way / Easement": [
        "vacate alley", "vacate street", "vacate right-of-way", "row vacation",
        "street vacation", "alley vacation", "alley abandonment",
        "right-of-way abandonment", "easement dedication", "utility easement",
        "drainage easement", "access easement", "right-of-way dedication",
        "row dedication", "dedicate right-of-way",
    ],
    "TIRZ / Tax Increment": [
        "tirz", "tax increment reinvestment zone", "tax increment financing",
        "tif district", "reinvestment zone", "tirz board", "increment financing",
        "project and financing plan", "tirz boundary", "tirz amendment",
    ],
    "Public Improvement District": [
        "public improvement district", "pid assessment", "pid boundary",
        "pid creation", "pid service plan", "assessment district",
        "pid amendment", "pid dissolution",
    ],
    "Development Code / Standards": [
        "unified development code", "udc amendment", "subdivision ordinance",
        "subdivision regulation", "development standard", "setback requirement",
        "parking ratio", "parking standard", "building code amendment",
        "tree preservation", "landscaping requirement", "sign ordinance",
        "form-based code", "design standard", "overlay district", "design overlay",
        "historic landmark", "historic overlay", "historic district",
        "certificate of appropriateness",
    ],
    "Land Acquisition / Disposition": [
        "acquire real property", "acquire land", "purchase of property",
        "surplus property", "convey property", "sell city property",
        "deed of conveyance", "right of first refusal", "option to purchase",
        "purchase agreement for", "land sale", "property disposition",
        "authorize city manager to execute deed", "eminent domain", "condemnation",
        "right-of-entry", "license agreement for land",
    ],
    "Utility Extension / Infrastructure": [
        "water line extension", "sewer extension", "water main extension",
        "wastewater extension", "utility extension agreement", "developer-funded",
        "water service agreement", "sanitary sewer service",
        "extend water service", "extend sewer service", "infrastructure agreement",
        "utility service area", "ccn amendment", "certificate of convenience",
    ],
